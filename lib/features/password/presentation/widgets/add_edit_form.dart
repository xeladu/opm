...
import 'package:open_password_manager/features/password/application/use_cases/edit_password_entry.dart';
  ...
  Future<void> _save() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      widget.entry == null || widget.entry!.id.isEmpty
          ? await AddPasswordEntry(repo).call(entry)
          : await EditPasswordEntry(repo).call(entry);
